...
def questions(request, modulei_id):
    ...
    return render_to_response('question_list.html', {'module': module, 'modulei':modulei, 'usermodule':usermodule, 'questions': questions})
...
def submit(request, modulei_id):
    ...
    return render_to_response('question_list_answered.html', {'module': module, 'modulei': modulei, 'usermodule':usermodule, 'questions': questions, 'totals': totals })
...
def questions_tagged(request,tag_id):
    ...
    return render_to_response('question_tag_list.html', {'tag': tag, 'questions': questions})
