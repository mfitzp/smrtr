...
urlpatterns = patterns('',
     ...
     url(r'^mi(?P<modulei_id>\d+)$', 'spenglr.questions.views.questions', name='question-module-exam' ),
     url(r'^mi(?P<modulei_id>\d+)/submit$', 'spenglr.questions.views.submit', name='question-module-submit'),
