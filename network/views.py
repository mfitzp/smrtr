...
from spenglr.network.forms import UserNetworkRegisterForm
...
def network_detail(request, network_id):
    ...
    return render_to_response('network/network_detail.html', {'network': network, 'usernetwork': usernetwork})
