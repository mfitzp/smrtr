...
# Notifications are built on the comment system with additional fields for 
# media, links, etc.
# Original models/code from django-threadedcomments

class Notification(Comment):

    # Parent-tree structure fields (threadedcomments)
    # allow multi-depth, but not required here
    ...
    # Custom fields for notification type
